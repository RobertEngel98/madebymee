// // components/Team/FounderTextBlock.jsx
// export default function FounderTextBlock() {
//   return (
//     <div className="founder_text">
//       <h3 className="fw-bold mb-3">Wir geben deinem Unternehmen den Auftritt, den eure Qualität verdient – und holen euch raus aus 08/15-Anzeigen rein in die Feeds eurer Wunschmitarbeiter und Kunden!</h3>
//       <p>
...
//           <strong>Lukas</strong> kommt aus dem Vertrieb und hat seit über … Jahren nichts anderes gemacht, als Menschen von Angeboten zu überzeugen – am Telefon, im Termin, auf Messen. Er weiß, welche Botschaften wirklich ziehen und wie man sie so
//           formuliert, dass sie nicht nach Werbung klingen, sondern nach echter Chance.
//         </p>

//         <p className="text-lg leading-relaxed text-neutral-200">
//           <strong>Robert</strong> hat bereits Werbebudgets im Wert von mehreren Mio. € verantwortet und lebt Performance-Ads. Er versteht, wie Kampagnen funktionieren, warum der erste Eindruck im Feed über Erfolg oder Totalausfall entscheidet – und
//           wie man Content so baut, dass er nicht einfach ausgespielt, sondern genutzt wird.
//         </p>

//         <p className="text-lg leading-relaxed text-neutral-200">
//           <strong>Leander</strong> hat seine Passion in der Content Creation gefunden. Schon früh haben ihn Videographie, Schnitt und Storytelling mehr interessiert als klassischer Konsum. Heute denkt er in Hooks, Formaten und Bildern – mit einem
//           Gefühl dafür, was auf Social Media wirklich hängenbleibt.
//         </p>

//         <p className="text-lg leading-relaxed text-neutral-200">
//           Aus dieser Kombination ist <strong>madebymee</strong> entstanden: eine Content-Schmiede für den Mittelstand, die nicht einfach „schöne Videos“ produziert, sondern Medien baut, die konkrete Probleme lösen:
//         </p>
...
//         <p className="text-lg leading-relaxed text-neutral-200">Wir arbeiten jung im Kopf, klar in der Ansprache und professionell in der Umsetzung.</p>

//         <p className="text-lg leading-relaxed text-neutral-200">
//           Wenn dein Unternehmen bereit ist, die alte Anzeigen-Welt hinter sich zu lassen und dort sichtbar zu werden, wo Aufmerksamkeit heute wirklich passiert, dann sollten wir miteinander reden.
//         </p>
//       </div>
//     </div>
//   );
